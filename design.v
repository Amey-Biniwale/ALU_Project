...
mrameter WIDTH = 8, CMD_WIDTH = 4)(
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																					                                        ...
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																					                                        default: ERR_M <= 1;
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																										                                endcase
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						                        ...
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						                        RES_M <= RES_M; OFLOW_M <= OFLOW_M; COUT_M <= COUT_M; E_M <= E_M; G_M <= G_M; L_M <= L_M; ERR_M <= ERR_M;
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																														...
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																														endmoduleodule top#(parameter WIDTH = 8, CMD_WIDTH = 4)(
	input CLK, RST, CIN, CE, MODE,
	input [WIDTH-1:0] OPA, OPB,
	input [CMD_WIDTH-1:0] CMD,
	input [1:0] INP_VALID,
	...
	always @(posedge CLK or posedge RST) begin
		...
		else if(MODE == 1 && ((CMD == 9 && PREV_CMD == 9) || (CMD == 10 && PREV_CMD == 10))) begin
			COUNT <= COUNT + 1;
		end
		else begin
			COUNT <= 0;
		...
		if(RST) begin //RESETS ALL OUTPUTS TO 0
			...
			if(MODE) begin
				case(CMD)
					...
					9: begin //MUL_INC (LOOK INTO IT LATER) (MIGHT WORK WITH CURRENT VERSION)
						if(INP_VALID == 3) begin
							if(COUNT == 0) begin
								WAIT_RES <= (OPA + 1) * (OPB + 1);
								RES_M <= 1'bx;
							end
					...
					10: begin //MUL_SHI (LOOK INTO IT LATER) (MIGHT WORK WITH CURRENT VERSION)
						if(INP_VALID == 3) begin
							if(COUNT == 0) begin
								WAIT_RES <= (OPA << 1) * (OPB);
								RES_M <= 1'bx;
					...
					11: begin //SIGNED_ADD (LOOK INTO IT LATER)
						if(INP_VALID == 3) begin
							RES_M <= $signed(OPA) + $signed(OPB);
							OFLOW_M <= (OPA[WIDTH-1] == OPB[WIDTH-1]) && (TEMP_ADD[WIDTH-1] != OPA[WIDTH-1]);
						end
					...
					12: begin //SIGNED_SUB (LOOK INTO IT LATER)
						if(INP_VALID == 3) begin
							RES_M <= $signed(OPA) - $signed(OPB);
							OFLOW_M <= (OPA[WIDTH-1] != OPB[WIDTH-1]) && (TEMP_SUB[WIDTH-1] != OPA[WIDTH-1]);
						end
